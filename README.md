About r-future.apply-feedstock
==============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-future.apply-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1162&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-future.apply-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-future.apply` can be installed with `conda`:
...
```
mamba install r-future.apply
```

It is possible to list all of the versions of `r-future.apply` available on your platform with `conda`:
...
```
mamba search r-future.apply --channel conda-forge
```
...
mamba repoquery search r-future.apply --channel conda-forge

# List packages depending on `r-future.apply`:
mamba repoquery whoneeds r-future.apply --channel conda-forge

# List dependencies of `r-future.apply`:
mamba repoquery depends r-future.apply --channel conda-forge
```
